...
static const struct pios_led pios_leds[] = {
	[PIOS_LED_HEARTBEAT] = {		// PB3: LED1 (sparky: USB_PWR)
		.pin = {
			.gpio = GPIOB,
			.init = {
				.GPIO_Pin   = GPIO_Pin_3,
...
// I2C INTERNAL: I2C1 PB6/PB7 (was I2C2 PA9/PA10)
...
static const struct pios_flash_partition pios_flash_partition_table[] = {
	{
		...
		.first_sector = 112,    // 08038000
		.last_sector  = 119,    // 0803B800
		.chip_offset  = (112 * FLASH_SECTOR_2KB),
		.size         = 8 * FLASH_SECTOR_2KB,
	},

	{
		.label        = FLASH_PARTITION_LABEL_WAYPOINTS,
		.chip_desc    = &pios_flash_chip_internal,
		.first_sector = 120,    // 0803C000
		.last_sector  = 127,    // 0803F800
		.chip_offset  = (120 * FLASH_SECTOR_2KB),
		.size         = 8 * FLASH_SECTOR_2KB,
	},
};
 ...
 * S.Bus USART
 */
#error "S.Bus not implemented (USART2 no available)"
...
static const struct pios_usart_cfg pios_flexi_usart_cfg = {
	// USART3 PB10/PB11 (sparky: USART1 PB6/PB7)
	.regs = USART3,
	.remap = GPIO_AF_7,
	.init = {
...
static const struct pios_usart_cfg pios_main_usart_cfg = {	// USART1 PA9/PA10 (sparky: USART3 PB10/PB11)
	.regs = USART1,
	.remap = GPIO_AF_7,
	.init = {
		.USART_BaudRate = 57600,
...
#error "PWM Inputs not supported"
#endif
/*
 * PPM Input
 */
